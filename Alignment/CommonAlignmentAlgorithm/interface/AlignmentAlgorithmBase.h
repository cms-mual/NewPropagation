...
namespace reco { class Track; class BeamSpot; class Muon;}
...
public:
  ...
  public:
    EventInfo(const edm::EventID &theEventId, 
	      ...
	      const reco::TrackCollection &theTrackCollection)
      : eventId_(theEventId), trajTrackPairs_(theTrajTrackPairs), beamSpot_(theBeamSpot), clusterValueMap_(theClusterValueMap), muonCollection_(theMuonCollection), trackCollection_(theTrackCollection) {}
    ...
    const reco::MuonCollection& muonCollection() const { return muonCollection_; }
    const reco::TrackCollection& trackCollection() const { return trackCollection_; }
