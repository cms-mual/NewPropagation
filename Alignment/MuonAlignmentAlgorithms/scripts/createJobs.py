...
parser.add_option("--preFilter",
                  ...
                  action="store_true",
                  dest="preFilter")
parser.add_option("--useMuons",
                  help="If invoked use muons based approach, if not use trajectories",
                  action="store_true",
                  dest="useMuons")
parser.add_option("--muonCollectionTag",
                  help="If not empty, it's InputTag of muons collection to use in muons based approach, e.g., 'muons' or 'muAlMuons'",
                  type="string",
                  default="muAlMuons",
                  dest="muonCollectionTag")
parser.add_option("--trackCollectionTag",
                  help="If not empty, it's InputTag of tracks collection to use in muons based approach, e.g., 'generalTracks' or 'muAlGeneralTracks'",
                  type="string",
                  default="muAlGeneralTracks",
                  dest="trackCollectionTag")
...
useMuons = options.useMuons
muonCollectionTag = options.muonCollectionTag
trackCollectionTag = options.trackCollectionTag
...
export ALIGNMENT_USEMUONS=%(useMuons)s
export ALIGNMENT_MUONCOLLECTIONTAG=%(muonCollectionTag)s
export ALIGNMENT_TRACKCOLLECTIONTAG=%(trackCollectionTag)s
...
if [ \"$ALIGNMENT_ITERATION\" == \"%(ITERATIONS)s\" ]; then
  ...
  echo \" ### about to run motionPolicyChamber.py ###\"
...
echo \" ### do fits and median plots first ###\"
