...
#muAlGeneralTracks = TrackRefitter.clone()
#muAlGeneralTracks.NavigationSchool = "" # Yuriy: This line requres to fix "Looking for type: MeasurementTrackerEvent" error
...
looper.recoMuonCollectionTag = cms.InputTag("muAlMuons")
looper.recoTrackCollectionTag = cms.InputTag("muAlGeneralTracks")
looper.useMuons = cms.untracked.bool(True)
# AR
