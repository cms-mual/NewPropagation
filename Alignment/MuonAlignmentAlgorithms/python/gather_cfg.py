...
trackCollectionTag = os.environ["ALIGNMENT_TRACKCOLLECTIONTAG"]
useMuons = (os.environ["ALIGNMENT_USEMUONS"] == "True")
print "useMuons: ", useMuons
...
#This is being called from somewhere else? AR
...
process.looper.algoConfig.useMuons = cms.bool(useMuons)
...
if mapplots:
    ...
    process.looper.monitorConfig.AlignmentMonitorMuonSystemMap1D.trackCollectionTag = cms.InputTag(trackCollectionTag)
    process.looper.monitorConfig.AlignmentMonitorMuonSystemMap1D.useMuons = cms.bool(useMuons)
...
if segdiffplots:
    ...
    process.looper.monitorConfig.AlignmentMonitorSegmentDifferences.trackCollectionTag = cms.InputTag(trackCollectionTag)
    process.looper.monitorConfig.AlignmentMonitorSegmentDifferences.useMuons = cms.bool(useMuons)
...
if curvatureplots:
    ...
    process.looper.monitorConfig.AlignmentMonitorMuonVsCurvature.trackCollectionTag = cms.InputTag(trackCollectionTag)
    process.looper.monitorConfig.AlignmentMonitorMuonVsCurvature.useMuons = cms.bool(useMuons)
...
process.muAlGeneralTracks.NavigationSchool = "" # Yuriy: This line requres to fix "Looking for type: MeasurementTrackerEvent" error
...
if iscosmics:
    ...
    if preFilter: process.Path = cms.Path(process.offlineBeamSpot * process.MuonAlignmentPreFilter * process.MuonAlignmentFromReferenceGlobalCosmicRefit * process.muAlGeneralTracks * process.muAlAncientMuonSeed * process.muAlStandAloneMuons * process.muAlGlobalMuons * process.muAlTevMuons * process.muAlGlbTrackQual * process.muAlMuons)
    else: process.Path = cms.Path(process.offlineBeamSpot * process.MuonAlignmentFromReferenceGlobalCosmicRefit * process.muAlGeneralTracks * process.muAlAncientMuonSeed * process.muAlStandAloneMuons * process.muAlGlobalMuons * process.muAlTevMuons * process.muAlGlbTrackQual * process.muAlMuons)
    ...
    if preFilter: process.Path = cms.Path(process.offlineBeamSpot * process.MuonAlignmentPreFilter * process.MuonAlignmentFromReferenceGlobalMuonRefit * process.muAlGeneralTracks * process.muAlAncientMuonSeed * process.muAlStandAloneMuons * process.muAlGlobalMuons * process.muAlTevMuons * process.muAlGlbTrackQual * process.muAlMuons)
    else: process.Path = cms.Path(process.offlineBeamSpot * process.MuonAlignmentFromReferenceGlobalMuonRefit * process.muAlGeneralTracks * process.muAlAncientMuonSeed * process.muAlStandAloneMuons * process.muAlGlobalMuons * process.muAlTevMuons * process.muAlGlbTrackQual * process.muAlMuons)
